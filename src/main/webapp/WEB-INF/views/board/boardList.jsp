              		...
              		<form action="boardList.do" id="searchForm" method="post">
              			<input type="hidden" name="cntPerPage" value="${pDto.cntPerPage}"/>
	              			<div class="d-flex justify-content-end"> <!-- end 는 맨 왼쪽 -->
		              			...
		              			<!-- 검색OK 버튼 -->
		              			<button class="btn rounded-0 rounded-end" style="background:#8080ff; color:white">
