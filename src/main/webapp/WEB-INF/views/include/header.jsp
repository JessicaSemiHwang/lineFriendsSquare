...
<!-- <header> -->
		...
		<nav class="navbar navbar-expand-sm p-4 menubar shadow">  <!-- css폴더에서 main.css 색상정하기 <head>에 link 넣어주기 -->
<!-- 		  <div class="container fluid"> -->
		  <div class="container menu_container">
		    <ul class="navbar-nav w-100 menus">
		      ...
		      <c:if test="${sessionScope.loginDTO.id != null && sessionScope.mode == 'user'}">
			      <li class="nav-item ms-auto d-flex"><!-- 부모 li의 w-100을 줘야지 ms-auto가 먹음 -->
			      	<a class="me-3 myProfile" type="button" style="color:white" "href="<c:url value="/memberInfo.do?find=info&no=${sessionScope.loginDTO.no}"/>">
			      		<i class="fa fa-user-circle">&nbsp;</i>${sessionScope.loginDTO.id} 님</a>&nbsp;&nbsp;
	...
	<!-- <div class="container-fluid justify-content-between d-flex" style="padding:0"> -->
