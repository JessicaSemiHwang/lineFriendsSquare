...
<div class="container w-50 mt-5 p-5 shadow">
      ...
      <h4 class="text-center">글 상세보기</h4><br>
	      ...
	      <div class="mt-5 mb-3 d-flex justify-content-between">
	      	...
	      	<button id="btn-addReply" class="btn btn-sm btn-outline-secondary" data-bs-target="#replyModal" data-bs-toggle="modal" style="color:black">새 댓글</button>
	      </div>
...
/* 		replyFunc.update(
		...
		let viewPage = 1;
		let replyArea = $(".replyArea"); // 특정게시글 안에 댓글리스트 영역으로 접속 
