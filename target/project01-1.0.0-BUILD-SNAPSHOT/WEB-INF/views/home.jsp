...
<!-- <div> -->
	<!-- <div class="container-fluid justify-content-between" style="padding:0"> -->
		...
		<div id="demo" class="carousel slide" data-bs-ride="carousel">
		  ...
		  <div class="carousel-inner">
		    <div class="carousel-item active">
		      <img src="resources/imgs/1.jpg" alt="bunnies" class="d-block" style="width:100%">
		    ...
		    <div class="carousel-item">
		      <img src="resources/imgs/2.jpg" alt="line_friends" class="d-block" style="width:100%">
				  <div class="carousel-caption">
				    		<h3>Line Friends</h3>
				    	<p>We had such a great time in LA!</p>
				  </div>
		    ...
		    <div class="carousel-item">
		      <img src="resources/imgs/3.jpg" alt="new_jeans" class="d-block" style="width:100%">
				  <div class="carousel-caption">
				    		<h3>New Jeans</h3>
				    	<p>We had such a great time in LA!</p>
				  </div>
		    ...
		    <div class="carousel-item">
		      <img src="resources/imgs/4.jpg" alt="la" class="d-block" style="width:100%">
				  <div class="carousel-caption">
				   		 	<h3>Los Angeles</h3>
				    	<p>We had such a great time in LA!</p>
				  </div>
